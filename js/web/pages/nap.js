...
import ArtistProgram from '../components/ArtistProgram'

const ArtistProgramPage = () => {
  return (
    <>
      <Head>
        <title>Nina Protocol - Artist Program</title>
        <meta
          name="description"
        ...
        <meta name="twitter:title" content="Nina Protocol - Artist Program" />
        <meta
...
export default ArtistProgramPage
